...
| 軸 | 低 | 中 | 高 |
|---|---|---|---|
| **① データ機密度**(→A-3) | 公開情報 | 社内情報 | 機密・最機密(個人情報/営業秘密/顧客提供データ) |
...
- 新規ユースケースは **C-1 申請・審査フロー**(→[04](04-operational-flows.md))に乗せ、4軸で格付け→区分判定。
- **④可逆性が「不可逆」または②自律度が「自動実行」なら、最低でも承認制 + HITL必須**(→[03](03-three-pillars-to-be.md) B-2)。
