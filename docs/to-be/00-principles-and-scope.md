...
D群(S1で方向性が出ている大きな設計判断)を正式な前提として記録する。
...
### D-1 ガバナンス体制類型 → **Functional 起点、将来 Centralized へ移行**
...
### D-3 エージェント自律度の許容方針 → **Least-Agency + 単一エージェント境界維持**
